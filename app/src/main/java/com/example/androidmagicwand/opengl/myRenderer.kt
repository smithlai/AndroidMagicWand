...
//    private val mGLES30: GLES30? = null
    ...
    override fun onDrawFrame(glUnused: GL10) {
        ...
        Matrix.setLookAtM(mViewMatrix, 0, 10f, 0f, 0f, 0f, 0f, 0f, 0f, 1.0f, 0.0f)
...
//        Matrix.translateM(mRotationMatrix, 0, x, y, 0f)
        ...
        Matrix.rotateM(mRotationMatrix, 0, x, .0f, 1.0f, 0.0f)
        Matrix.rotateM(mRotationMatrix, 0, y, 0.0f, 0.0f, 1.0f)
...
//        mAngle += .4.toFloat()
    ...
    override fun onSurfaceChanged(glUnused: GL10, width: Int, height: Int) {
        ...
        Matrix.perspectiveM(mProjectionMatrix, 0, 30f, aspect, Z_NEAR, Z_FAR)
    }
